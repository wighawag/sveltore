// from https://github.com/sveltejs/svelte/blob/ed078e31fe1d3594c105a17f7fb6def769b386f6/src/runtime/store/index.ts
import { run_all, subscribe, noop, safe_not_equal, is_function, get_store_value } from './svelte_internals_utils';
